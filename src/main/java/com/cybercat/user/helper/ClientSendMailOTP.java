...
public class ClientSendMailOTP {
	public static void mailSend(String mail, String name, String content) throws Exception {
		String to = mail;
		...
		try {
			...
			message.setSubject("HI "+name.toUpperCase()+", GREETINGS FROM CYBERCAT");
			File htmlFile = new File("home/assessment_template.html");
